...
static const std::string rocksdb_build_git_sha  = "rocksdb_build_git_sha:d542b8b862768d0968dfe63b537955bf056b97b1";
static const std::string rocksdb_build_git_tag = "rocksdb_build_git_tag:io_uring";
#define HAS_GIT_CHANGES 1
#if HAS_GIT_CHANGES == 0
// If HAS_GIT_CHANGES is 0, the GIT date is used.
// Use the time the branch/tag was last modified
static const std::string rocksdb_build_date = "rocksdb_build_date:2024-11-15 19:22:50";
#else
// If HAS_GIT_CHANGES is > 0, the branch/tag has modifications.
// Use the time the build was created.
static const std::string rocksdb_build_date = "rocksdb_build_date:2024-12-04 07:00:13";
#endif
